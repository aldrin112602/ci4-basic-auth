<div style="min-height: 85vh;" class="d-flex align-items-center justify-content-center container-fluid p-5">
    <form action="<?php echo base_url(); ?>/SignupController/store" method="post" class="col-lg-4 col-md-5 col-12 p-5 py-3 shadow-lg bg-white border" style="border-radius: 70px; color: #092635;">
        ...
        <div class="my-1">
            ...
            <input value="<?= session()->getFlashdata('data')['email'] ?? null ?>" required type="email" name="email" class="form-control form-control-sm border border-1" style="height: 45px; border-radius: 18px; padding: 0 30px;">
        </div>
        <div class="my-1">
